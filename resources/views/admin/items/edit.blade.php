                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.items.update', $items -> id)}}"
                                              method="POST">
                                            @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $items -> name_ar }}" id="name_ar"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name_ar">
                                                            @error("name_ar")
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $items -> name_en }}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name_en">
                                                            @error("name_en")
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $items -> quantity }}" id="quantity"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="quantity">
                                                            @error("quantity")
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $items -> price }}" id="price"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="price">
                                                            @error("price")
                                                                ...
                                                                <optgroup label="من فضلك أختر القسم ">
                                                                    @if($subcats && $subcats -> count() > 0)
                                                                        @foreach($subcats as $subcat)
                                                                            <option
                                                                                value="{{$subcat -> id }}"
                                                                         @if($items -> subcat_id == $subcat -> id )  selected @endif
