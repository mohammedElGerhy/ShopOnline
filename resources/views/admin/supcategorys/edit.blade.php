                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> Edt Sub Category </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.supcategorys.update', $subcat -> id)}}"
                                              method="POST">
                                            @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$subcat -> name_ar}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name_ar">
                                                            @error("name_ar")
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$subcat -> name_en}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name_en">
                                                            @error("name_en")
                                                            ...
                                                            <optgroup label="من فضلك أختر القسم ">
                                                                @if($categorys && $categorys -> count() > 0)
                                                                    @foreach($categorys as $category)
                                                                        <option
                                                                            value="{{$category -> id }}">
                                                                           @if($subcat -> maincategory_id == $category -> id) selected @endif</option>
                                                                    @endforeach
                                                                @endif
                                                            </optgroup>
                                                        </select>
