                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.maincategorys.update', $maincat -> id)}}"
                                              method="POST">
                                            @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$maincat->name_ar}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name_ar">
                                                            @error("name_ar")
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$maincat->name_en}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name_en">
                                                            @error("name_en")
